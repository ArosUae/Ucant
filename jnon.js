...
$("[data-target=#wall]").attr('title','   „”‹‹‹«ÕÂ Õ‹‹—Â ·√»‹‹œ¬⁄« ﬂ‹‹„            ')

$('.nav-tabs').addClass('fl').css('width','100%');
$('.nav-tabs').addClass('fl').css('width','100%');
$(`<link href="" rel="stylesheet">
<link rel="stylesheet" href="https://rawcdn.githack.com/omar-alhaded/msj/a8a739b34765ff4339d3d49b61e40ef8c41d6c61/g.css">
<style>
...
Tsend_=Tsend;
reqlikes=10;
Tsend=function(){if(getuser(myid).rep<reqlikes){alert('·≈ Ì„ﬂ‰ﬂ «·ﬂ «»… »«·⁄«„ Ì ÿ·» „‰ﬂ «·Õ’Ê· ⁄·Ï ·«Ìﬂ« '+reqlikes+' '); return;}else{Tsend_();}}

sendpic_=sendpic;
reqlikes=10;
sendpic=function(){if(getuser(myid).rep<reqlikes){alert('·≈ Ì„ﬂ‰ﬂ  €Ì— ’Ê— ﬂ Ì ÿ·» „‰ﬂ «·Õ’Ê· ⁄·Ï ·«Ìﬂ«  '+reqlikes+''); return;}else{sendpic_();}}

setprofile_=setprofile;
reqlikes=10;
setprofile=function(){if(getuser(myid).rep<reqlikes){alert('·« Ì„ﬂ‰ﬂ Õ›Ÿ «·√⁄œ«œ«  Ì ÿ·» „‰ﬂ «·Õ’Ê· ⁄·Ï ·«Ìﬂ«  '+reqlikes+''); return;}else{setprofile_();}}
